...
import com.backstagesupporters.fasttrack.models.HomeModel2;
...
public class HomeDashboardAdapter extends RecyclerView.Adapter<HomeDashboardAdapter.MyViewHolder> {
    ...
    private List<HomeModel2> dataList =new ArrayList<>();
...
//    private  LanguageModel myLanguageList[];
    ...
    public HomeDashboardAdapter(Context mContext, List<HomeModel2> language) {
        this.dataList = language;
        this.mContext = mContext;
//        Log.i(TAG,"-- constructor");
    }

    public HomeDashboardAdapter(final List<HomeModel2> data) {
        this.dataList = data;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_home_dashboard, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        // find list card_view
        final HomeModel2 modelList = dataList.get(position);
//        Log.i(TAG,"getTitleHead-"+modelList.getTitleHead1());

        // tv_titleHead, tv_title1, tv_title2, tv_title3

        holder.setIsRecyclable(false);
        holder.tv_titleHead1.setText(modelList.getTitleHead1());
        holder.tv_titleHead2.setText(modelList.getTitleHead2());
...
//                Log.i(TAG,"Welcome - "+modelList.getTitleHead1());
...
//        return position % 4;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ImageView ivUpDown;
        TextView tv_titleHead1,tv_titleHead2, tv_title1, tv_title2, tv_title3;
        /**
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv_titleHead2 = itemView.findViewById(R.id.tv_titleHead2);
