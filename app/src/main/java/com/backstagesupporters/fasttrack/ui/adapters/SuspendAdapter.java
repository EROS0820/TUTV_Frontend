...
public class SuspendAdapter extends RecyclerView.Adapter<SuspendAdapter.MyViewHolder> {
    //    private String TAG= getClass().getSimpleName();
    private static final String TAG = "fasttrack";
    private Context mContext;
    private List<SuspendModel> dataList =new ArrayList<>();
...
//    private  LanguageModel myLanguageList[];
    ...
    public SuspendAdapter(Context mContext, List<SuspendModel> dataList) {
        this.dataList = dataList;
        this.mContext = mContext;
//        Log.i(TAG,"-- constructor");
    }

    public SuspendAdapter(final List<SuspendModel> data) {
        this.dataList = data;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_suspend, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        // find list card_view
        final SuspendModel modelList = dataList.get(position);
...
//                createRotateAnimator(holder.buttonLayout, 0f, 180f).start();
                ...
                holder.btn_suspend.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toasty.success(mContext,"You have Suspend Device:"+modelList.getDeviceName(), Toast.LENGTH_SHORT).show();
