...
public class DistanceReportViewAllAdapter extends RecyclerView.Adapter<DistanceReportViewAllAdapter.MyViewHolder> {
    ...
    public DistanceReportViewAllAdapter(Context mContext, List<DistanceReport> deviceModels) {
...
//        Log.i(TAG,"-- constructor");
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_distance_report_all, viewGroup, false);
...
//        Log.w(TAG,"Rounding myDistance: "+myDistance);
        holder.tv_distance.setText(myDistance);
    }
