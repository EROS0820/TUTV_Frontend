...
public class TripDetailsFragment_1 extends BaseActivity implements OnMapReadyCallback, TripDetailsView, View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = TripDetailsFragment_1.this;
                    ...
                    .getMapAsync(googleMap -> {
                        ...
                        gmap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback() {
                            ...
                            public void onMapLoaded() {
                                ...
                                if (latLngsList!=null){
                                    Log.e(TAG,"latLngsList size :"+latLngsList.size());
