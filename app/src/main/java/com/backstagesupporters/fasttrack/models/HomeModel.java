...
public class HomeModel {
    private String titleHead,titleHead1, title1,title2,title3;
    ...
    public HomeModel(String description, int colorId1, int colorId2, TimeInterpolator interpolator) {
    ...
    public HomeModel(String titleHead,String titleHead1, String title1, String title2, String title3, int image_id, TimeInterpolator interpolator) {
